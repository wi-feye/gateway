        ...
        <>
            <Grid container rowSpacing={4.5} columnSpacing={2.75}>
                ...
                <Grid item xs={12} sm={6} md={4} lg={3}>
                    <LittleCard title="Busiest area" content={mostBusy ? mostBusy.areaName : "N\\A"}
                                subtitle="This area is really busy right now"/>
                </Grid>
                <Grid item xs={12} sm={6} md={4} lg={3}>
                    <LittleCard title="Less busy area" content={lessBusy ? lessBusy.areaName : "N\\A"}
                                subtitle="This area is not so busy right now"/>
                </Grid>
                <Grid item xs={12} sm={6} md={4} lg={3}>
                    <LittleCard title="Areas" content={areas ? areas.length.toString() : "0"} color="warning"
                                subtitle="Number of areas in the building"/>
                </Grid>
                <Grid item xs={12} sm={6} md={4} lg={3}>
                    <LittleCard title="Sniffers" content={devices ? devices.length.toString() : "0"} color="warning"
                                subtitle="Powered by Zerynth"/>
                </Grid>
                ...
                <Grid item xs={12} md={5} lg={4}>
                    ...
                    <MainCard sx={{mt: 2.5}}>
                        <Stack spacing={3}>
                            ...
                            <Button size="small" variant="contained" onClick={handleClickOpenHelp}
